    ...
    return (
        ...
        <img src={logo} alt="Logo" />
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/theculguy0099" target="_blank">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/kevin-thakkar-6aa19a253/" target="_blank">
...
<p>LinkedIn</p>
                ...
                <a className="twitter" href="https://www.instagram.com/_kevin1104/" target="_blank">
...
<p>Instagram</p>
                ...
                <a className="schedule" href="https://www.facebook.com/profile.php?id=100085606601056" target="_blank">
...
<p>Facebook</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-five"><a className="nav-link" href="mailto:kevinrt1923@gmail.com" target="_blank">Contact</a></li>
                    </ul>
                    </div>    
            </div>
            </div>
